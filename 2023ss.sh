...
-A INPUT -p tcp -m multiport --dports 81,1723,22,44158,2023,20231,8080,8443 -j ACCEPT
...
cp -r glider_0.16.3_linux_amd64/glider /usr/sbin/glider
chmod +x /usr/sbin/glider
nohup glider -listen ss://AES-256-GCM:20231@:20231   -verbose &
chmod +x /etc/rc.d/rc.local
systemctl enable rc-local.service
systemctl start rc-local.service
systemctl restart rc-local.service
echo "glider -listen ss://AES-256-GCM:20231@:20231   -verbose &" >>  /etc/rc.d/rc.local
systemctl restart rc-local.service
#glider 代理
